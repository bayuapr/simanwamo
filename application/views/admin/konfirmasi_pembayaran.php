            ...
            <div class="card-body">
                <form action="<?php echo base_url('admin/transaksi/cek_pembayaran/') ?>" method="POST">
                    <?php foreach ($pembayaran as $pmb) : ?>
                        <a class="btn btn-sm btn-success" href="<?php echo base_url('admin/transaksi/download_pembayaran/' . $pmb->id_sewa) ?>"><i class="fas fa-download"></i>Download Bukti Pembayaran</a>
                        <div class="custom-control custom-switch ml-5">
                            <input type="hidden" class="custom-control-input" value="<?php echo $pmb->id_sewa ?>" name="id_sewa">
